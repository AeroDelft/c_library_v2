...
#define MAVLINK_THIS_XML_HASH -3915280334494047268
...
typedef enum PARAM_TRANSACTION_RESPONSE
{
   ...
   PARAM_TRANSACTION_RESPONSE_INPROGRESS=3, /* Transaction in progress. | */
   PARAM_TRANSACTION_RESPONSE_ENUM_END=4, /*  | */
...
#include "./mavlink_msg_gimbal_manager_set_tiltpan.h"
...
#include "./mavlink_msg_param_ext_value_trimmed.h"
#include "./mavlink_msg_param_ext_set_trimmed.h"
#include "./mavlink_msg_param_ext_ack_trimmed.h"
#include "./mavlink_msg_param_start_transaction.h"
#include "./mavlink_msg_param_commit_transaction.h"
